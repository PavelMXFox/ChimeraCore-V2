...
$id = fox\common::clearInput($request->parameters[0]);
?>
...
<div style="display: inline-block; float: left;">
  <ul>
  	 <li><a href="#tab-groups">Группы</a></li>
     <li><a href="#tab-acls">ACL</a></li>	
     <li><a href="#tab-docs">Документы</a></li>
 </ul>
</div>
...
<div id="tab-groups" buttons="buttons_docs">
	<div class="widget">
...
<div id="tab-acls" buttons="buttons_docs">
	<div class="widget">
			<p>Данные загружаются</p>
	</div>
